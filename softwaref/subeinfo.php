           ...
           /* echo '<script type="text/javascript">
                ...
                if (!file_exists($directorio)){
                    ...
                    if ($resultado){
                            ...
                            subir($directorio,$nombre,$proveedor,$descripcion,$url1,$url2,$url3);
...
function subir($ruta,$nombre,$proveedor,$descripcion,$url1,$url2,$url3){
...
el nombre de nuestra imagen */
 $sql = "INSERT INTO software(id,ruta,nombre,proveedor,descripcion,url1,url2,url3) VALUES (NULL,'$ruta','$nombre','$proveedor','$descripcion','$url1','$url2','$url3')";
