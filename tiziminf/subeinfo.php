           ...
           /* echo '<script type="text/javascript">
                ...
                if (!file_exists($directorio)){
                    ...
                    if ($resultado){
                            ...
                            subir($directorio,$nombre,$fecha,$lugar,$url1);
                          ...
                          //  header("location:subirsoft.php");
                              echo "<script>window.location='subirtiz.php';</script>";
...
function subir($ruta,$nombre,$fecha,$lugar,$url1){
...
el nombre de nuestra imagen */
 $sql = "INSERT INTO tizimin(id,ruta,nombre,fecha,lugar,url1) VALUES (NULL,'$ruta','$nombre','$fecha','$lugar','$url1')";
