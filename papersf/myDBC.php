...
class myDBC{
    ...
    public function subirTodo($ruta,$nombre,$autor,$descripcion,$url1,$url2){

		
		$q = "INSERT INTO libros (ruta,nombre,autor,descripcion,url1,url2) VALUES ('$ruta','$nombre','$autor','$descripcion','$url1','$url2')";
